...
struct _GstFramebufferSinkClass
{
  ...
  GstVideoFormat *(*get_supported_overlay_formats) (GstFramebufferSink *
      framebuffersink);
  /* Return the video alignment (top/bottom/left/right padding and stride
    ...
    gboolean (*get_overlay_video_alignment) (GstFramebufferSink
      * framebuffersink, GstVideoInfo * video_info,
    ...
    GstFlowReturn (*show_overlay) (GstFramebufferSink * framebuffersink,
      GstMemory * memory);
  GstAllocator *(*video_memory_allocator_new) (GstFramebufferSink *
