    ...
    GstAllocationParams * params)
{
  ...
  /* Atmel specific IOCTL to get the physical address of gem object 
     ...
     physical address of buffer, Otherwise an unneccessary memcpy 
    ...
    GstMemory * memory)
{
  ...
  if (drmsink->lcd) {
    ...
    cw = drmsink->mode.hdisplay / 2;
    ch = drmsink->mode.vdisplay / 2;
